...
public class Timer {
	private static final Logger console = LoggerFactory.getLogger(Timer.class);
	...
	public static void end() {
		...
		console.info("计时结束,结束时间:" + s.format(date) + "耗时:" + (end - begin) + "毫秒 (" + (nend - nbegin) + "纳秒)");
		initTimer();
	}
	...
	public static void start() {
		...
		console.info("计时开始,开始时间:" + s.format(date));
	}
}
